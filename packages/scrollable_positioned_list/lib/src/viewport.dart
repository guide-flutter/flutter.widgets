...
class UnboundedRenderViewport extends RenderViewport {
  ...
  double _attemptLayout(
    ...
    final double leadingOffset = (leadingNegativeChild != null ? leadingNegativeChild.geometry?.scrollExtent ?? 0 : 0);
    final double trailingOffset = (trailingPositiveChild != null ? trailingPositiveChild.geometry?.scrollExtent ?? 0 : 0);
    final double centerBodyOffset = (center != null ? center!.geometry?.scrollExtent ?? 0 : 0);
    ...
    if (leadingOffset + centerBodyOffset + trailingOffset > 0) {
      if (leadingOffset + centerBodyOffset + trailingOffset < mainAxisExtent) {
        ...
        centerOffset = centerOffset.clamp(
          ...
          leadingOffset + (leadingOffset > mainAxisExtent ? mainAxisExtent * anchor : 0),
        );
      }
    }
